"use strict";
// "use strict" is to indicate that the code should be executed 
// in "strict mode". With strict mode, you can not, for example, use undeclared variables. 
...
//Importing Algorithm
// ready() method is used to make a function available after the document is loaded.
$(document).ready(function () {
  ...
  // change() method triggers the change event,me
